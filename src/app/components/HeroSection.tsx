        ...
        ></div> */}
               ...
               lg:bg-gradient-to-l lg:from-transparent lg:from-[52.21%] lg:to-[rgba(18,60,140,0.4)] lg:to-[60.75%]"
				...
				<div className="max-w-[600px] absolute bottom-[15%] left-[5%]">
					<TextReveal>
						<h1 className="font-satoshi lg:text-[64px] text-[40px] font-semibold">CONTACT US</h1>
						<p className="lg:text-2xl text-base font-generalSans">Every journey is unique and every experience matters.</p>
					</TextReveal>
				</div>
