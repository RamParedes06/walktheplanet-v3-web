              ...
              <div className="space-y-1 overflow-hidden text-[14px]">
                ...
                <p>
                  ...
                  <Link
                    ...
                    className="text-cyan-300 underline flex"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
          ...
          >
            <div className="pl-12 pr-4 text-white/90 space-y-4  max-[490px]:text-[14px]">
              ...
              <div className="space-y-1">
                ...
                <p>
                  <a
                    href="https://mail.google.com/mail/?view=cm&fs=1&to=corp@walktheplanet.com"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-cyan-300 underline"
                  >
              ...
              <div className="space-y-1">
                ...
                <p>
                  <a
                    href="https://mail.google.com/mail/?view=cm&fs=1&to=mice@walktheplanet.com"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-cyan-300 underline"
                  >
