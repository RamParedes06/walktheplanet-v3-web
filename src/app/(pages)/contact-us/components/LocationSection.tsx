...
import mapMobile from "@/assets/images/contact/CroppedMap.webp";

export default function LocationSection() {
  return (
    <section className="relative w-full h-[600px] md:h-[500px] overflow-hidden text-center md:text-start">
      {/* Map Background */}
      ...
      <div className="relative z-10 h-full flex flex-col justify-center p-8 md:p-16 max-w-xl">
        <h2 className="text-white text-[16px] md:text-lg font-semibold mb-4">
          You may visit us at
        </h2>

        <p className="text-white text-[16px] md:text-lg mb-8 leading-relaxed">
        ...
        <p className="text-white text-[16px] md:text-lg mb-10 leading-relaxed">
