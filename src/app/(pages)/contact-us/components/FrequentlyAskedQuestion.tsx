    ...
    <div className="flex flex-col lg:flex-row w-full h-auto">
      <section className="w-full lg:w-1/2 bg-[#E7F0FF] flex flex-col justify-end relative overflow-hidden h-auto">
        ...
        <div className="absolute md:hidden block">
          <Image src={bgMobile} alt="Background Illustration" />
        </div>
        ...
        <div className="relative z-10 px-2 py-20 md:px-10 lg:px-20 ml-4 lg:ml-8 mb-2">
          ...
          <h1 className="msd:block hidden text-[40px] md:text-3xl lg:text-[64px] text-[#333] font-semibold leading-none mt-2">
            ASKED QUESTIONS
          </h1>
      ...
      {/* Right Section */}
      <section className="w-full md:w-1/2 bg-white flex flex-col justify-center items-center md:min-h-screen">
        {/* Form */}
        <FAQSection />
      </section>
    </div>
