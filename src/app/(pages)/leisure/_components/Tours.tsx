...
const Tours = ({ productsVersion = false }: ToursProps) => {
	...
	return (
		<div className="w-full h-screen mx-auto rounded-lg shadow-lg overflow-hidden">
			<div className={`relative h-full flex flex-col items-center px-0 py-4 md:p-8 pb-0 bg-white`}>
				...
				{/* Description */}
				<TextReveal>
					<div className={`pt-[64px] md:pt-[54px] z-10 flex flex-col items-center`}>
