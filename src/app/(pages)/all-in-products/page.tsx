...
import Hero from '@/app/(pages)/all-in-products/_components/Hero'
...
function AllInProducts() {
  ...
  return (
    <>
      ...
      <Hero
        ...
        description={
          <div className="flex flex-col">
            {!isMobile ? (
              <p>
                <span className="font-medium text-[#7EE7FC]">Explore our personalized travel services</span> designed for
      ...
      />
      <FlightCarousel />
      <CarouselTitle title="TRANSPORTATION" description={<p>Water, air, and land - move smoothly and hassle-free for an incredible journey</p>} images={TranspoImages} backgroundImage={TranspoBG} />
      <Accomodations />
      <Cruise />
      <Documentation />
      <CarouselTitle
