...
const bgDomestic =
  "https://res.cloudinary.com/dxg7sn3cy/image/upload/v1745472642/Tilted_Container_iq7eje.png";
const bgInternational =
  "https://res.cloudinary.com/dxg7sn3cy/image/upload/v1745476015/international_zrcmuz.png";
...
function ToursPackages() {
  ...
  return (
    <div
      className="h-screen bg-black bg-cover bg-center bg-no-repeat relative transition-all ease-in-out"
        ...
        <div className="flex flex-col gap-10 text-2xl font-generalSans z-1 items-center">
          <div className="flex flex-col gap-5">
            ...
            <p className="text-center max-[490px]:text-[16px] px-1">
              {isMobile ? (
                <i>
                  Get the keys to a complete and{" "}
                  <span className="font-semibold">hassle-free</span> <br />
                  experience - unlock your dream escape <br /> with our all-in
                  packages!
                </i>
              ) : (
                <i>
                  Get the keys to a complete and{" "}
                  <span className="font-semibold">hassle-free experience</span>{" "}
                  <br /> - unlock your dream escape with our all-in packages!
                </i>
              )}
            </p>
          </div>
          <div className="buttons flex gap-2 max-[490px]:flex-col">
            <button
              ...
              className={`px-[24px] py-4 rounded-2xl max-[490px]:rounded-full flex items-center justify-center text-[16px] font-semibold cursor-pointer ${
                isDomestic
                  ? "bg-white text-[#00537F]"
                  : "bg-[#FFFFFF33] border-2 backdrop-blur-sm border-white text-white"
              }`}
            >
              Domestic Packages
            </button>
