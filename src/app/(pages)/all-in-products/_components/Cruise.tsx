...
const bg = "https://res.cloudinary.com/dmxvasob7/image/upload/v1745461999/cc46bdcce0720f77fcd7ca98f2890137ddd0abbf_uhujak.webp";

function Cruise() {
	return (
		<div className="h-screen bg-cover bg-center bg-no-repeat relative " style={{ backgroundImage: `url(${bg})` }}>
			<div
				className="overlay flex absolute inset-0 top-0 "
				style={{
					background: "linear-gradient(185.25deg, rgba(0, 169, 206, 0) 20.67%, rgba(255, 255, 255, 0.26304) 60.44%, #FFFFFF 82.53%)",
				}}
			>
