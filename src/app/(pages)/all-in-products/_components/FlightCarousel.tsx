...
import {
  FlightImagesDomestic,
  FlightImagesInternational,
} from "@/library/FlightCarousel";
...
function FlightCarousel() {
  ...
  return (
    <div className="relative h-screen w-full flex flex-col justify-center items-center text-white bg-black overflow-hidden">
      ...
      <div className="relative z-20 rounded-xl flex flex-col gap-50 items-center w-full max-w-[1000px]">
        <div className="text-center flex flex-col gap-2">
          <h1 className="uppercase text-[64px] font-bold font-satoshi max-[490px]:text-[40px]">
            Flights
          </h1>
          ...
          <p className="italic text-2xl max-[490px]:text-[16px]">
            We’ve got <span className="font-medium">great deals</span> for your
            next adventure!
          </p>
        </div>
        ...
        <div className="carousel-container flex flex-col items-center gap-30 max-[490px]:gap-5">
          ...
          <div className="flex gap-5 text-lg font-medium min-[491px]:hidden">
            <span
              className={`cursor-pointer ${
                isDomestic ? "text-white" : "text-white/60 hover:text-white"
              } pb-1`}
              onClick={() => {
                setIsDomestic(true);
                setProgress(0);
          ...
          <div className="relative flex items-end justify-center gap-6 w-full">
            {[-2, -1].map((offset) => {
              ...
              const index =
                (activeIndex + offset + TOTAL_IMAGES) % TOTAL_IMAGES;
              return (
