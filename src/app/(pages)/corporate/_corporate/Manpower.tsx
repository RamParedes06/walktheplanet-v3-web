		...
		<div className="relative w-screen h-screen">
			...
			<div className="absolute top-0 left-0 w-full h-full flex flex-col sm:flex-row bg-white  overflow-hidden">
				...
				<div className="absolute top-0 left-0 right-0 h-full z-10">
					{/* Content Container */}
					<div className="lg:max-w-[55%] py-[20px] px-[24px] lg:py-[112px] lg:px-[80px] h-full flex flex-col lg:justify-end justify-start">
						<TextReveal>
							<p className="font-[900] lg:text-[64px] text-[30px] text-[#14476F] font-satoshi uppercase">Manpower agencies & OFW Deployment</p>
							<div className="text-black lg:text-2xl text-base font-generalSans">
