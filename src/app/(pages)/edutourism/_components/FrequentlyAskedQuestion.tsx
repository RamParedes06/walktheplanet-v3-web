	...
	return (
		<div className="flex flex-col lg:flex-row w-full h-auto lg:h-screen">
			...
			<section className="w-full lg:w-1/2 bg-[#D0F6FF] flex flex-col justify-end relative overflow-hidden h-auto lg:h-full">
				...
				>
					<Image src={bg} alt="Background Illustration" className="opacity-30" />
				</div>
				...
				<div className="relative z-10 px-2 py-20 md:px-10 lg:px-20 ml-4 lg:ml-8 mb-6">
					...
					<h1 className="text-[40px] md:text-3xl lg:text-[64px] text-[#333] font-semibold leading-none mt-2">ASKED QUESTION</h1>
					<p className="text-base lg:text-[24px] mt-4 lg:mt-8 text-[#333]">Before you pack your bags, get the details you need for a stress-free trip</p>
				</div>
			</section>
