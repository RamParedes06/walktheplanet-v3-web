...
function CarouselTitle({ title, description, images }: CarouselProps) {
  return (
    <div className="h-screen bg-white overflow-hidden">
      <div
        className="h-[40%] max-[490px]:h-[30%] relative overflow-hidden flex items-center max-[490px]:bg-center"
      ...
      >
        <div className="p-20 w-full max-[490px]:p-0 ">
          ...
          <div className="flex flex-col gap-2 max-[490px]:px-5 max-[490px]:gap-5">
            <TextReveal>
              <div className="text-[64px] max-[490px]:text-[40px] font-extrabold text-[#14476F] font-satoshi uppercase">
                {title}
              </div>
