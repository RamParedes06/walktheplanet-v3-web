		...
		<div className="h-screen bg-white overflow-hidden">
			<div className="h-[40%] max-[490px]:h-[45%] relative overflow-hidden flex items-center max-[490px]:bg-center" style={{ backgroundImage: `url(${illustration})` }}>
				<div className="p-20 w-full max-[490px]:p-0 ">
					{backgroundImage &&
						(isMobile ? (
							<Image src={backgroundImage} alt="" width={1200} className="absolute top-35 -right-40 w-[1900px] h-auto object-contain z-0 scale-180" />
						) : (
							<Image src={backgroundImage} alt="" width={1200} className={version ? "absolute -top-50 -right-30 rotate-110" : "absolute top-0 right-0"} />
						))}
