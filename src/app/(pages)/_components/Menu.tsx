							...
							<div className="flex lg:gap-[48px]  overflow-y-auto h-full">
								...
								<div className="relative !w-[600px] hidden lg:block ">
									<Image
										...
										width={600}
										height={600}
										className={` !w-[600px]  md:h-[90%] h-full object-cover absolute transition-all duration-500 ease-in-out ${
												...
												<div className="flex gap-5">
													...
													<div className="relative w-8 h-8">
														...
														<Image
															...
															onClick={() =>
																window.open("https://ph.linkedin.com/company/walktheplanet?trk=public_post_feed-actor-name", "_blank", "noopener,noreferrer")
															}
														/>
													</div>
												</div>
