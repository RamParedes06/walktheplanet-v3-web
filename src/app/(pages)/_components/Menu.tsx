													...
													<div key={`left-${index}`} className="relative group">
														<Link
															...
															className={`text-base transition-all duration-200 hover:text-[#00537F] inline-flex items-center ${
																item.highlighted ? "text-[#00537F] font-medium" : "text-gray-700 hover:text-[#333333] hover:font-medium"
													...
													<div key={`right-${index}`} className="relative group">
														...
														>
															<Image
																...
																width={10}
																height={10}
																className={`${!item.highlighted ? "brightness-75 sepia-100 hue-rotate-180" : ""}`}
															/>
														</div>
													</div>
												);
