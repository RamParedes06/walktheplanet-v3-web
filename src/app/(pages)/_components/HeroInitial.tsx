...
const tabs: Tab[] = [
  {
    id: 'edutourism',
    title: 'EDUTOURISM',
    image: CloudflareR2Storage + '/homepage/hero/Hero1Figma_xcgzrt.png',
  ...
  },
  {
    ...
    image: CloudflareR2Storage + '/homepage/hero/Corporate_Business_1_4_dab6y2.png',
  ...
  },
  {
    id: 'mice',
    title: 'M.I.C.E',
    image: CloudflareR2Storage + '/homepage/hero/MICE_1_2_c65uoh.png',
  ...
  },
  {
    ...
    image: CloudflareR2Storage + '/homepage/hero/Travel_Essentials_Global_Data_Sim_1_1_ieqaf6.png',
  ...
  },
  {
    id: 'liveselling',
    title: 'LIVE SELLING',
    image: CloudflareR2Storage + '/homepage/hero/Live_Selling_Tiktok_zjfzai.png',
  ...
  },
  {
    id: 'onlinestore',
    title: 'ONLINE STORE',
    image: CloudflareR2Storage + '/homepage/hero/Online_Store_t1xmy8.png',
  ...
  },
  {
    id: 'aboutus',
    title: 'ABOUT US',
    image: CloudflareR2Storage + '/homepage/hero/hero-aboutus_rjysnm.png',
...
export default function Hero() {
  ...
  //! Hiding the navbar menu when it reaches the footer
    ...
    <>
      ...
      <div className="w-full relative overflow-hidden rounded-xl max-[480px]:rounded-none max-w-full mx-auto flex justify-between z-50">
        <div className="lg:hidden">
          {/* Logo Menu */}
          <div ref={headerContainerMobileRef} className="fixed z-10 top-[70px] w-full flex items-center justify-center transition-opacity duration-300">
            {/* Header - only visible when menu is closed */}
