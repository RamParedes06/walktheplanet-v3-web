...
function GridMotionMobile() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-black min-[770px]:hidden overflow-hidden">
      <div className="absolute top-0 left-0 z-5 bg-gradient-to-t from-transparent via-[rgba(0,0,0,0)] via-[70%] to-[rgba(0,0,0,3)] h-full w-full"></div>
      <div className="absolute top-0 left-0 z-5 bg-gradient-to-b from-transparent via-[rgba(0,0,0,0)] via-[70%] to-[rgba(0,0,0,3)] h-full w-full"></div>
